...
public class FakeServer {
     ...
     */
//    public static final String APP_KEY = "0vnjpoad0cz5z";

    /**
     * 务必妥善保存, 不能放在应用端, 否则可以被反编译获得.
     */
//    public static final String APP_SECRET = "NB7XgH8GSvaDf2";
//    public static final String APP_KEY = "c9kqb3rdcv9ij";
    public static final String APP_KEY = "6tnym1br6jtz7";

    /**
     * 务必妥善保存, 不能放在应用端, 否则可以被反编译获得.
     */
//    public static final String APP_SECRET = "eKGwoB3Y8s";
    public static final String APP_SECRET = "6PQMdHFulX";

//       APP_KEY       c9kqb3rdcv9ij
//       APP_SECRET     eKGwoB3Y8s
     ...
     * @param callback
     */
    public static void remove(String url,String userid,String room,String minite, HttpUtil.OnResponse callback) {
        HttpUtil.Header header = HttpUtil.getRcHeader(APP_KEY, APP_SECRET);
        String body = "userId=" + userid + "&chatroomId=" + room+ "&minute=" + minite;
        HttpUtil httpUtil = new HttpUtil();
        httpUtil.post(url, header, body, callback);
    }
    /**
     * 查询封禁列表
     *
     * @param callback
     */
    public static void checkRemove(String url,String room, HttpUtil.OnResponse callback) {
        HttpUtil.Header header = HttpUtil.getRcHeader(APP_KEY, APP_SECRET);
        String body = "chatroomId=" + room;
        HttpUtil httpUtil = new HttpUtil();
        httpUtil.post(url, header, body, callback);
    }
