...
public class InputPanel_pc extends LinearLayout {
    ...
    public InputPanel_pc(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    private void initView() {
        LayoutInflater.from(getContext()).inflate(R.layout.widget_input_panel_pc, this);
